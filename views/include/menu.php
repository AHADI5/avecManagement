<div class="menu-content">
    ...
    <div class="menucontent flex">
        ...
        <li>
            ...
            <li>
                <a href="./avec.php" class="menu-link">
                    <div class="icon"><i class="bi bi-collection"></i></div>
                    <div class="menu">Avec</div>
                </a>
            </li>
            <li>
                <a href="./membres.php" class = "menu-link">
                   <div class="icon"> <i class="bi bi-people-fill"></i></div>
                    <div class="menu">Membres</div>
                </a>
            </li>
            <li>
                <a href="./creditsAll.php" class = "menu-link">
                    <div class="icon">  <i class="bi bi-credit-card-fill"></i></div>
                    <div class="menu">Credits</div>
                </a>
            </li>
            <li>
                <a href="./epargnesAll.php" class = "menu-link">
                    <div class="icon"><i class="bi bi-cash-coin"></i></div>
                    <div class="menu">Epargnes</div>
                </a>
            </li>
            <li>
                <a href="./socialAll.php" class = "menu-link">
